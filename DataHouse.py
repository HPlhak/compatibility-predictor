...
def compatibility(json_data):
    ...
    for person in applicants:
        ...
        #intelligence is weighted more than other categories
        totalCompatibility = (2*intelligenceCompatibility +strengthCompatibility + enduranceCompatibility + spiceCompatibility)/5
